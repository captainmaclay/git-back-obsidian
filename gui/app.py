...
from core.logger import log_main, log_soft, log_both, get_logger
from core.config import GITHUB_PROFILE_URL
from core.single_instance import SingleInstance
from gui.tray import setup_tray_and_close_protocol, create_exit_button, create_tray_icon
